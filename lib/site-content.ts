...
export const SITE_MESSAGES: Record<Locale, Messages> = {
  ...
  en: {
    ...
    home: {
      ...
      spotsLeft: (count) => `${count} ${count === 1 ? "spot" : "spots"} left`,
  ...
  da: {
    ...
    home: {
      ...
      nextStatus: "Næste",
      locationLabel: "Sted",
      spotsLeft: (count) => `${count} ${count === 1 ? "plads" : "pladser"} tilbage`,
  ...
  sv: {
    ...
    home: {
      ...
      nextStatus: "Nästa",
      locationLabel: "Plats",
      spotsLeft: (count) => `${count} ${count === 1 ? "plats" : "platser"} kvar`,
  ...
  fr: {
    ...
    home: {
      ...
      locationLabel: "Lieu",
      spotsLeft: (count) => `${count} ${count === 1 ? "place restante" : "places restantes"}`,
  ...
  es: {
    ...
    home: {
      ...
      nextStatus: "Próximo",
      locationLabel: "Lugar",
      spotsLeft: (count) => `${count} ${count === 1 ? "plaza libre" : "plazas libres"}`,
  ...
  de: {
    ...
    home: {
      ...
      nextStatus: "Nächste",
      locationLabel: "Ort",
      spotsLeft: (count) => `${count} ${count === 1 ? "Platz" : "Plätze"} frei`,
