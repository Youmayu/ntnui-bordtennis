...
export const LEGAL_TRANSLATIONS: Record<Exclude<Locale, "no" | "en">, LegalCopy> = {
  da: {
    ...
    registerNotice: "Vi bruger dit fornavn, efternavn, spilleniveau og fødselsmåned/-dag til at administrere din tilmelding. Dit navn vises offentligt på deltager- og afmeldingslister, også når du står på ventelisten. Dine fødselsoplysninger er ikke offentlige. Læs, hvordan vi bruger og opbevarer dine oplysninger, før du tilmelder dig.",
      ...
      privacy: {
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              "Vi gemmer dit fornavn og efternavn som fuldt navn, valgte spilleniveau, fødselsmåned og -dag, valgte træning, tilmeldingstidspunkt og status som bekræftet eller på ventelisten. Fornavn, efternavn, spilleniveau og fødselsmåned/-dag er nødvendige for tilmelding på nettet. Vi beder ikke om dit fødselsår. Fødselsoplysninger hjælper med at skelne tilmeldinger fra hinanden og kontrollere afmeldinger; spilleniveau hjælper med at organisere træningen.",
          ...
          },
          {
            ...
            paragraphs: ["Dit navn er synligt for besøgende på deltager- og afmeldingslister. Din plads på ventelisten og status som bekræftet eller på venteliste er også offentlige. Fødselsmåned/-dag vises ikke offentligt. Autoriserede administratorer kan få adgang til tilmeldingsoplysninger for at organisere træninger og håndtere anmodninger. Kontakt os, hvis offentlig visning af dit navn forhindrer dig i at tilmelde dig på nettet."],
          },
          {
            id: "purposes",
  ...
  sv: {
    ...
    registerNotice: "Vi använder ditt förnamn och efternamn, din spelnivå och din födelsemånad/-dag för att hantera din anmälan. Ditt namn visas offentligt i deltagar- och avanmälningslistor, även när du står på väntelistan. Dina födelseuppgifter är inte offentliga. Läs hur vi använder och sparar dina uppgifter innan du anmäler dig.",
      ...
      privacy: {
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              "Wir speichern deinen Vor- und Nachnamen als vollständigen Namen, das gewählte Spielniveau, Geburtsmonat und -tag, die gewählte Trainingseinheit, den Anmeldezeitpunkt sowie den Status als bestätigt oder auf der Warteliste. Vorname, Nachname, Spielniveau sowie Geburtsmonat und -tag sind für die Online-Anmeldung erforderlich. Wir fragen nicht nach deinem Geburtsjahr. Geburtsangaben helfen, Anmeldungen zu unterscheiden und Abmeldungen zu prüfen; das Spielniveau hilft bei der Organisation des Trainings.",
          ...
          },
          {
            ...
            paragraphs: ["Dein Name ist für Website-Besucher in Teilnehmer- und Abmeldelisten sichtbar. Auch dein Platz auf der Warteliste und dein Status als bestätigt oder auf der Warteliste sind öffentlich. Geburtsmonat und -tag werden nicht öffentlich angezeigt. Berechtigte Administratoren können auf Anmeldedaten zugreifen, um Trainingseinheiten zu organisieren und Anfragen zu bearbeiten. Kontaktiere uns, wenn die öffentliche Anzeige deines Namens dich an der Online-Anmeldung hindert."],
          },
          {
            id: "purposes",
  ...
  zh: {
    ...
    registerNotice: "我们使用你的名、姓、打球水平以及出生月份和日期来管理报名。你的姓名会公开显示在参加者名单和取消报名名单中，包括你在候补名单中的情况。出生信息不会公开。请在报名前阅读我们如何使用和保存你的信息。",
      ...
      privacy: {
        ...
        sections: [
          ...
          },
          {
            ...
            title: "训练报名",
            paragraphs: [
              "我们将你的名和姓合并为完整姓名保存，并保存所选打球水平、出生月份和日期、所选训练场次、报名时间以及已确认或候补状态。在线报名必须分别填写名、姓、打球水平以及出生月份和日期。我们不会询问你的出生年份。出生信息有助于区分报名记录和核验取消报名的请求；打球水平有助于组织训练。",
          ...
          },
          {
            id: "visibility",
            title: "其他人可以看到什么",
            paragraphs: ["网站访客可以在参加者名单和取消报名名单中看到你的姓名。你的候补顺序以及已确认或候补状态也会公开显示。出生月份和日期不会公开显示。获授权的管理员可以访问报名信息，以组织训练和处理请求。如果公开显示姓名妨碍你使用在线报名，请联系我们。"],
          },
          {
            id: "purposes",
            title: "我们为何使用这些信息",
  ...
  fr: {
    ...
    registerNotice: "Nous utilisons ton prénom, ton nom de famille, ton niveau de jeu ainsi que ton mois et ton jour de naissance pour gérer ton inscription. Ton nom est public dans les listes de participants et de désinscription, y compris lorsque tu es sur liste d’attente. Tes informations de naissance ne sont pas publiques. Lis comment nous utilisons et conservons tes informations avant de t’inscrire.",
      ...
      privacy: {
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              "Guardamos tu nombre y apellidos como nombre completo, nivel de juego seleccionado, mes y día de nacimiento, sesión elegida, hora de inscripción y estado confirmado o en lista de espera. El nombre, los apellidos, el nivel de juego y el mes y día de nacimiento son necesarios para inscribirse en línea. No pedimos tu año de nacimiento. Los datos de nacimiento ayudan a distinguir las inscripciones y comprobar las cancelaciones; el nivel de juego ayuda a organizar los entrenamientos.",
          ...
          },
          {
            ...
            paragraphs: ["Tu nombre es visible para los visitantes del sitio en las listas de participantes y de cancelación. Tu posición en la lista de espera y tu estado confirmado o en espera también son públicos. El mes y el día de nacimiento no se muestran públicamente. Los administradores autorizados pueden acceder a la información de inscripción para organizar sesiones y resolver solicitudes. Contacta con nosotros si la publicación de tu nombre te impide inscribirte en línea."],
          },
          {
            id: "purposes",
