...
const COPY: Record<Locale, RegistrationCopy> = {
  no: {
    ...
    automaticUpdates: "Oppdateres automatisk hvert 30. sekund.",
    refresh: "Oppdater listen",
    loading: "Henter påmeldinger …",
    loadError: "Kunne ikke oppdatere påmeldingene. Listen kan være utdatert. Prøv igjen.",
    firstName: "Fornavn",
    lastName: "Etternavn",
  ...
  en: {
    ...
    automaticUpdates: "Updates automatically every 30 seconds.",
    refresh: "Refresh list",
    loading: "Loading registrations …",
    loadError: "Could not update registrations. The list may be out of date. Please try again.",
  ...
  da: {
    ...
    emptyWaitlist: "Ingen på ventelisten.",
    automaticUpdates: "Opdateres automatisk hvert 30. sekund.",
    refresh: "Opdater listen",
    loading: "Henter tilmeldinger …",
    loadError: "Tilmeldingerne kunne ikke opdateres. Listen kan være forældet. Prøv igen.",
    firstName: "Fornavn",
    lastName: "Efternavn",
  ...
  sv: {
    ...
    automaticUpdates: "Uppdateras automatiskt var 30:e sekund.",
    refresh: "Uppdatera listan",
    loading: "Hämtar anmälningar …",
    loadError: "Kunde inte uppdatera anmälningarna. Listan kan vara inaktuell. Försök igen.",
    firstName: "Förnamn",
    lastName: "Efternamn",
  ...
  de: {
    ...
    automaticUpdates: "Wird alle 30 Sekunden automatisch aktualisiert.",
    refresh: "Liste aktualisieren",
    loading: "Anmeldungen werden geladen …",
    loadError: "Die Anmeldungen konnten nicht aktualisiert werden. Die Liste ist möglicherweise veraltet. Bitte erneut versuchen.",
    firstName: "Vorname",
    lastName: "Nachname",
  ...
  zh: {
    ...
    automaticUpdates: "每30秒自动更新。",
    refresh: "刷新名单",
    loading: "正在加载报名名单……",
    loadError: "无法更新报名名单。名单可能已过时，请重试。",
    firstName: "名",
    lastName: "姓",
  ...
  fr: {
    ...
    automaticUpdates: "Actualisation automatique toutes les 30 secondes.",
    refresh: "Actualiser la liste",
    loading: "Chargement des inscriptions…",
    loadError: "Impossible d’actualiser les inscriptions. La liste peut être obsolète. Veuillez réessayer.",
    firstName: "Prénom",
  ...
  es: {
    ...
    automaticUpdates: "Se actualiza automáticamente cada 30 segundos.",
    refresh: "Actualizar lista",
    loading: "Cargando inscripciones…",
    loadError: "No se pudieron actualizar las inscripciones. La lista puede estar desactualizada. Inténtalo de nuevo.",
    firstName: "Nombre",
    lastName: "Apellidos",
